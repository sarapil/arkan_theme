...
```bash
bench --site dev.localhost get-untranslated ar --app arkan_theme
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `arkan_theme/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app arkan_theme | wc -l
```
...
2. Edit/create the CSV file in `arkan_theme/translations/`
