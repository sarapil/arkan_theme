...
bench get-app arkan_theme https://github.com/sarapil/arkan_theme.git

# Install on site — التثبيت على الموقع
bench --site your-site.localhost install-app arkan_theme
...
2. **Find the App** — ابحث عن التطبيق: Look for Arkan Theme icon on the desk
3. **Configure Settings** — اضبط الإعدادات: Go to Arkan Theme Settings
...
- 🐛 [Report Bug](https://github.com/sarapil/arkan_theme/issues/new?template=bug_report.yml)
- ✨ [Request Feature](https://github.com/sarapil/arkan_theme/issues/new?template=feature_request.yml)
