...
"""
ARKAN Theme — Demo Data
Load/clear demo data for ARKAN Theme showcases.
...
def load_demo_data():
    """Load demonstration data for ARKAN Theme.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for ARKAN Theme"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for ARKAN Theme"))
